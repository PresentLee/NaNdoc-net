"""
writer :  https://github.com/kaniblu/hangul-utils(GNU license)

This module contain functions composite korean token from onset,nucleus and coda.
To generate HTML documentation for this module issue the command:

    pydoc -w util/unicode.py
